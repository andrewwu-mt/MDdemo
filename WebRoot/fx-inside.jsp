...
<div id="wrapper">
	<div id="side-menu" _height="auto">
		...
		<ul id="menu">
			...
			<li><a href="map-inside.html" class="now-page">Currencies</a></li>
	...
	<div id="content-wrapper" _height="auto">
		<div id="page-content">
			...
			<iframe scrolling="no" class="inside-chart" src="http://localhost:8080/MDOL/quote?name=${name}&dataType=chart&type=fx&chartType=0&legendShow=0&legendAlign=0"></iframe>
		</div>
	</div>
